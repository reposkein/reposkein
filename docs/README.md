...
- **Running the optional services on a cluster?** → [`KUBERNETES.md`](KUBERNETES.md) — manifests for the embedding server and Neo4j, and an honest account of what that does and does not buy you.
